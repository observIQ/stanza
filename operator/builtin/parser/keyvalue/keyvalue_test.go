...
func TestKVParser(t *testing.T) {
	cases := []struct {
		...
		},
		{
			"user-agent",
			map[string]interface{}{
				"testfield": `requestClientApplication="Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0"`,
			},
			map[string]interface{}{
				"testparsed": map[string]interface{}{
