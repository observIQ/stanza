...
func TestGoogleCloudOutput(t *testing.T) {
	...
	cases := []googleCloudTestCase{
		...
		googleCloudSeverityTestCase(entry.Fatal4, sev.LogSeverity_EMERGENCY),
		googleCloudSeverityTestCase(entry.Severity(24), sev.LogSeverity_EMERGENCY),
		...
		googleCloudSeverityTestCase(entry.Error4, sev.LogSeverity_CRITICAL),
		googleCloudSeverityTestCase(entry.Severity(20), sev.LogSeverity_CRITICAL),
		...
		googleCloudSeverityTestCase(entry.Info4, sev.LogSeverity_NOTICE),
		googleCloudSeverityTestCase(entry.Severity(12), sev.LogSeverity_NOTICE),
