...
func TestNewRelicOutput(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			`[{"common":{"attributes":{"plugin":{"type":"stanza","version":"unknown"}}},"logs":[{"timestamp":1476089932000,"attributes":{"body":"test","labels":null,"resource":null,"severity":"default"},"message":"test"}]}]` + "\n",
		},
		{
			"Multi",
			nil,
			...
			`[{"common":{"attributes":{"plugin":{"type":"stanza","version":"unknown"}}},"logs":[{"timestamp":1476089932000,"attributes":{"body":"test1","labels":null,"resource":null,"severity":"default"},"message":"test1"},{"timestamp":1476089932000,"attributes":{"body":"test2","labels":null,"resource":null,"severity":"default"},"message":"test2"}]}]` + "\n",
		},
		{
			"CustomMessage",
			...
			`[{"common":{"attributes":{"plugin":{"type":"stanza","version":"unknown"}}},"logs":[{"timestamp":1476089932000,"attributes":{"body":{"log":"testlog","message":"testmessage"},"labels":null,"resource":null,"severity":"default"},"message":"testlog"}]}]` + "\n",
		},
	}
