...
`
	...
	expectedPattern := `{"timestamp":".*","severity":0,"labels":{"file_name":"input.log"},"body":{"message":"log1"}}
{"timestamp":".*","severity":0,"labels":{"file_name":"input.log"},"body":{"message":"log2"}}
{"timestamp":".*","severity":0,"labels":{"file_name":"input.log"},"body":{"message":"log3"}}
`
