...
`
	...
	expectedPattern := `{"timestamp":".*","severity":0,"attributes":{"file_name":"input.log"},"record":{"message":"log1"}}
{"timestamp":".*","severity":0,"attributes":{"file_name":"input.log"},"record":{"message":"log2"}}
{"timestamp":".*","severity":0,"attributes":{"file_name":"input.log"},"record":{"message":"log3"}}
`
