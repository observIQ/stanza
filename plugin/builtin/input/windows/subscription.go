...
func (s *Subscription) Read(maxReads int) ([]Event, error) {
	...
	// EvtNext will return ErrorInvalidOperation if there are no further items to read.
...
// createFlags will create the necessary read flags from the supplied arguments.
